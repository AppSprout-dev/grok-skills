...
Policy: `docs/PAIRED_TAU_GATE.md`. Required when this PR changes a Grok Bot skill, an MCP schema or manifest, or plugin surface. Paired parent/candidate evidence uses frozen replay V at `evals/c0_harness_v/` (AppSprout-dev/Petra). Ungated Tool edits are rejected and logged.
